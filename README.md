...
React is a library that introduces components which makes code easier to reuse

1. Describe component state.

Components are small chunks of code that can be reused and plugged in when and where they are needed

1. Describe props.

Props are information that Parents pass down to be used by children

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

A side effect is anything that effects something outside the scope of the function executed. You use efect hooks to change specific props and state.
